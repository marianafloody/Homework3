...
file_data_path= "/Users/marianafloody/Documents/S24/CSCI1430_Projects/Project 3/homework3_camerageometry-marianafloody/questions/images/bunny.xyz"
...
def calculate_camera_matrix(tx, ty, tz, alpha, beta, gamma, fx, fy, skew, u, v):
    ...
    xy = np.matmul(rx,ry)
    rot = np.matmul(xy,rz)
    extrin = [[rot[0][0],rot[0][1],rot[0][2],tx],[rot[1][0],rot[1][1],rot[1][2],ty],[rot[2][0],rot[2][1],rot[2][2],tz]]
    camera = np.matmul(intrin,extrin)

    return camera, intrin, extrin
